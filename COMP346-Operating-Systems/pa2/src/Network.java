...
public class Network extends Thread {
    ...
    private static Semaphore mutexIn, mutexOut;
    private static Semaphore inBufferEmpty, inBufferFull, outBufferEmpty, outBufferFull;
     ...
     */
     Network( )
      { 
         ...
         inBufferEmpty = new Semaphore(0);
         inBufferFull = new Semaphore(getMaxNbPackets());
         outBufferEmpty = new Semaphore(0);
         outBufferFull = new Semaphore(getMaxNbPackets());
      }     

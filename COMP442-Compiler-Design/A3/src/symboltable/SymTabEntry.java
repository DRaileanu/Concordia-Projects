...
public class SymTabEntry {
	...
	//public int             size       = 0;
	//public int             offset     = 0;
	//public ArrayList<Integer> dims       = new ArrayList<Integer>();//TODO delete as currently defined in VarEntry instead
	
	//public SymTabEntry() {}	
	// public SymTabEntry(String name, Kind kind, String type, SymTab scope, String linenum){
	// 	this.name = name;
	// 	this.kind = kind;
	// 	this.type = type;
	// 	this.scope = scope;
